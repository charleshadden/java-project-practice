...
//        (a class can only inherit from one superclass). However, it can be achieved with
//        interfaces, because the class can implement multiple interfaces. Note: To implement
